...
{
    public partial class FrmTalle : Form
    {
        public FrmTalle()
        {
            InitializeComponent();
        ...
        private void Listar()
        {
            try
            {
                DgvListado.DataSource = NTalle.listar();
                this.formato();
                Limpiar();
        ...
        private void FrmTalle_Load(object sender, EventArgs e)
        {
            Listar();
        }
        ...
        private void BtInsertar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Rpta = NTalle.Insertar(TxtNombre.Text.Trim());
                    if (Rpta.Equals("OK"))
                    {
        ...
        private void BtActualizar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Rpta =NTalle.Actualizar(Convert.ToInt32(Txtid.Text.Trim()), TxtNombre.Text.Trim());
                    if (Rpta.Equals("OK"))
                    {
