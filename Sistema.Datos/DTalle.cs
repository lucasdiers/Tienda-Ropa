    ...
    public  class DTalle
    {
        public DataTable listar() //  metodo para listar los atributos de la tabla categoria
        {
            ...
            try
            {
                ...
                SqlCommand Comando = new SqlCommand("talle_listar", SqlCon);
        ...
        public DataTable Seleccionar()
        {
            ...
            {
                SqlCon = Conexion.getInstancia().CrearConexion();
                SqlCommand Comando = new SqlCommand("Talle_seleccionar", SqlCon);
                Comando.CommandType = CommandType.StoredProcedure;
                SqlCon.Open();
                Resultado = Comando.ExecuteReader(); //ejecuta el comando
                Tabla.Load(Resultado);
        ...
        public string Existe(string Valor)
        {
            ...
            {
                SqlCon = Conexion.getInstancia().CrearConexion();
                SqlCommand Comando = new SqlCommand("talle_existe", SqlCon);
                Comando.CommandType = CommandType.StoredProcedure;
        ...
        public string Insertar(Talle obj)
        {
            string Rpta = "";
            SqlConnection SqlCon = new SqlConnection();
            try
            {
                SqlCon = Conexion.getInstancia().CrearConexion();
                SqlCommand Comando = new SqlCommand("talle_insertar", SqlCon);
                Comando.CommandType = CommandType.StoredProcedure;
        ...
        public string Actualizar(Talle obj)
        {
            string Rpta = "";
            SqlConnection SqlCon = new SqlConnection();
            try
            {
                SqlCon = Conexion.getInstancia().CrearConexion();
                SqlCommand Comando = new SqlCommand("talle_actualizar", SqlCon);
                Comando.CommandType = CommandType.StoredProcedure;
        ...
        public string Eliminar(int id)
        {
            ...
            {
                SqlCon = Conexion.getInstancia().CrearConexion();
                SqlCommand Comando = new SqlCommand("talle_eliminar", SqlCon);
                Comando.CommandType = CommandType.StoredProcedure;
                Comando.Parameters.Add("@idtalle", SqlDbType.Int).Value = id;
